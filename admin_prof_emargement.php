...
<div class="row">
  <div class="col">
	...
	<div class="col">
		<form class="" action="prof_script_emargement.php" method="post">
			<p class="text-center">Générer pour un professeur :</p>
			<div class="form-group">
				<select name="lst_prof" class="form-control">
					<?php
					include "connexion_bd_gesoraux.php";

					try {
						$lesEnreg=$bdd->query("SELECT utilisateur.id, nom, prenom FROM utilisateur join typeutilisateur on idTypeUtilisateur=typeutilisateur.id where libelle in('Admin','Prof')");
			...
			<div class="form-group d-flex justify-content-center">
				<input type="submit" class="btn btn-success btn-sm" name="btn_genererclasse" value="Générer">
			</div>
		</form>
	</div>
	<div class="col">
