...
<br><br><br>
<h2 class="text-center">Planning des épreuves par classe</h2>
<br><br>
<section>
<div class="container">
<div class="row">
  <div class="col">
	...
	<div class="col">
		<form class="" action="admin_script_fichesplanning.php" method="post">
			<p class="text-center">Générer pour la classe de :</p>
